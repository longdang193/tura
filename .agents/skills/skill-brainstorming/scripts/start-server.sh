...
# Resolve parent process PID (grandparent of this script).
# $PPID is ephemeral shell that started this script — it dies
# when this script exits. Parent process is $PPID's parent.
